...
/// `StubMacro` is an implementation of the `Spyable` macro, which generates a test spy class
...
///
/// After verifying the protocol, `StubMacro` uses a `StubFactory` to generate a new spy class declaration
...
public enum StubMacro: PeerMacro {
  private static let extractor = Extractor()
  private static let spyFactory = StubFactory()
